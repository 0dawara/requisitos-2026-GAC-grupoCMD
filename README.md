...
- **[`Requisitos/`](Requisitos/)**  
  Contém toda a documentação de engenharia de requisitos do projeto.
  - Documentos de Elicitação, Glossário e Visão da Demanda.
  - Especificação de Casos de Uso (CDU).
