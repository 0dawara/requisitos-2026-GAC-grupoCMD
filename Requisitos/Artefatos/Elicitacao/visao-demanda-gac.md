...
| **Atendentes (Secretaria)** | Usuário chave | Registrar movimentações (entrega/devolução) e validar checklists de avarias. | Kildery, Adail, etc |
...
* **Descrição:** Funcionário administrativo do suporte (ex: Kildery, Adail, etc) que interage balcão-a-balcão.
