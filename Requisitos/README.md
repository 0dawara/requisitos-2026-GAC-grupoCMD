...
Esta pasta concentra os artefatos de engenharia de requisitos do projeto **Sistema de Gestão de Ativos do CCT (GAC)**. A estrutura foi inspirada no modelo LAPIS de Liderança Ágil.

## Objetivo

Organizar o processo de requisitos para garantir:

- clareza do que deve ser construído;
- padronização dos artefatos;
- melhor comunicação entre time técnico e partes interessadas.
...
- `Requisitos Não Funcionais/`: especificações de Requisitos Não Funcionais (RNF).
